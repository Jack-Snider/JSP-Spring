...
public class FileSystemPropertyDAOImpl implements PropertyDAO{
	...
	private String path = "D:\\A_TeachingMaterial\\6.JspSpring\\JSP-Spring\\workspace\\WebStudy01\\src\\main\\resources\\kr\\or\\ddit\\props\\DataStore.properties";
	...
	public List<PropertyVO> selectProperties() {
		...
		List<PropertyVO> dataList = new ArrayList<PropertyVO>();
	...
	public void insertProperty(PropertyVO propertyVO) {
		...
		try(
			...
			properties.store( fos, String.format( "'%c' 에 저장함" , Calendar.getInstance()) );
