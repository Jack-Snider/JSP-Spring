...
<!DOCTYPE html>
	...
	<body>
		...
		<pre>
			...
			3. 속성 데이터 관리
				<%
					//request.setAttribute(arg0, arg1); 1
					//session.setAttribute(arg0, arg1); 2
					//application.setAttribute(arg0, arg1); 3
					//pageContext.setAttribute(name, value); 4
					//pageContext.setAttribute(name, value , PageContext.SESSION_SCOPE); 
				%>
			★★★★	Scope		: 해당 저장 영역을 관리하는 기본 객체와 생명주기가 동일한 저장 공간
					attribute 	: score를 통해 공유되는 데이터
			1.	page scope
			2.	request scope
			3.	session scope
			4.	application scope
			...
			<%
				...
				request.setAttribute( "requestttr" , "요청 속성" );
			...
			%>
			<a href = "<%= request.getContextPath() %>/attributeView.jsp">어트리뷰트 뷰로 이동</a>
		</pre>
	</body>
</html>